...
var app = {
    ...
    onDeviceReady: function () {
        ...
        inAppBrowserbRef = cordova.InAppBrowser.open('http://matthew.realdeal.com.eg/Azhari/', '_self', 'location=no,toolbar=no,zoom=no');

        //admob
     // Set AdMobAds options:
      admob.setOptions({
        publisherId:           "ca-app-pub-7251676025279948/8338727358",  // Required
        interstitialAdId:      "ca-app-pub-7251676025279948/1773319007",  // Optional
